...
const Signup = () => {
  ...
  return (
    <div className='w-full md:w-1/2 flex flex-col px-4 justify-center gap-4 items-center'>
      ...
      <form className='border-gray-500 transition-all hover:scale-101 ease-in-out duration-300 hover:shadow-lg hover:border-gray-200 hover:shadow-gray-700 w-full md:w-1/2 h-2/5 md:h-3/5 flex flex-col justify-evenly items-center border-2 rounded-lg p-4' onSubmit={submitform}>
